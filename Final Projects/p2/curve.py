...
class EnhancedBallTrajectoryAnalyzer:
    ...
    def create_background_model(self, video_path: str) -> bool:
        """
        Create an adaptive background model using both median and MOG2 methods
        """
        try:
            ...
            n_samples = min(30, frame_count - 1)

            # Systematic sampling instead of random
            sample_interval = frame_count // n_samples
            frames = []
            ...
            for i in range(n_samples):
                ...
                if ret:
                    frames.append(frame)
                    # Update MOG2 model if you have it initialized
    ...
    def detect_ball(self, frame: np.ndarray) -> Optional[Tuple[int, int]]:
        """
        Enhanced ball detection using multiple techniques and tracking
        """
        ...
        try:
            ...
            for contour in contours:
                ...
                if not (50 <= area <= 1000):  # Adjustable area thresholds
                    continue
                ...
                if circularity > 0.6:  # Adjustable circularity threshold
            ...
            # Select the most circular candidate
            best_candidate = max(candidates, key=lambda x: x[2])
            return (best_candidate[0], best_candidate[1])  # Return x, y coordinates
...
if __name__ == "__main__":
    ...
    video_path = "media/m/yellow_bigball.mp4"
